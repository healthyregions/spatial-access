...
DEFAULT_MATRICES = {
    'tract': {
        'car':pd.read_parquet('https://uchicago.box.com/shared/static/hkipez75z2p7zivtjdgsfzut4rhm6t6h.parquet'),
        'bike':pd.read_parquet('https://uchicago.box.com/shared/static/cvkq3dytr6rswzrxlgzeejmieq3n5aal.parquet'),
        'walk':pd.read_parquet('https://uchicago.box.com/shared/static/swggh8jxj59c7vpxzx1emt7jnd083rmh.parquet')
    },
    'zip': {
        'car':pd.read_parquet('https://uchicago.box.com/shared/static/swggh8jxj59c7vpxzx1emt7jnd083rmh.parquet'),
        'bike':pd.read_parquet('https://uchicago.box.com/shared/static/7yzgf1gx3k3sacntjqber6l40m0d5aqw.parquet'), 
        'walk':pd.read_parquet('https://uchicago.box.com/shared/static/b3vuqijqys24z146u78dsemn0wvu8i5m.parquet'),  
    }
}
...
class AccessMetricParser:
    ...
    def __init__(
        ...
        if transit_matrix is not None:
            ...
            self.set_transit_matrix(
                DEFAULT_MATRICES[self.geo_unit][self.transit_mode],
