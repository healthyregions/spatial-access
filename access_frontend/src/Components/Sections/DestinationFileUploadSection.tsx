	...
	if (!file) {
		return (
			<Box sx={{ marginBottom: "20px" }}>
				...
				<Typography variant="body1">
					Please select a csv file containing your resources with the following
					columns
					<ul>
						<li>
							A column which has a unique id for each resource destination
						</li>
...
export const FileSelection: React.FC<FileSelectionProps> = ({
	...
	const requiresPopulationFile =
		includeModelMetrics && populationSource === "custom";
...
const tooltip = (_job: Job) =>
	"You'll need to provide some additional information about your file before submitting.";
